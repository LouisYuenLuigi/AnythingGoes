...
public class Commands implements Hash {
	...
	/**
	 * @throws FileNotFoundException exception throwing in case file not found
	 * exports the user.txt file into the local directory
	 */
	public void exportUsers() throws FileNotFoundException {
		
		PrintWriter oos = new PrintWriter("users.txt");
