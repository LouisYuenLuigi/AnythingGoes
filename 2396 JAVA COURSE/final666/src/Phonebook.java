...
public class Phonebook {
	...
	int entry_count = 0;
	final String phfile = "C:\\Users\\User\\Desktop\\2396 JAVA COURSE\\final666\\src\\PB.dat";
	File pbfile;
	...
	public Phonebook(boolean autosaveflag) {
		...
		try {
			pbfile = new File("C:\\Users\\User\\Desktop\\2396 JAVA COURSE\\final666\\src\\PB.dat");
			System.out.println(pbfile.getAbsolutePath());
			if ( pbfile.exists() ) {
				pbis = new ObjectInputStream(new FileInputStream(pbfile));
				System.out.println("readin nigga");
	...
	//		returns 嚙�1 if nm is not in the entry_list
	...
	public void subtask_5_2() {
		...
		for (int i=0;i<entry_count;i++) {
			System.out.println(getEntry(i).name + ", "+ getEntry(i).address);
		}
