...
public class PBClient {	
	...
	void create_main_gui() {
		...
		jb_logoff.addActionListener(new logOffListener());
	...
	class logOffListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			SPBMessage logout = new SPBMessage("LOGOFF", null,null,new PhonebookEntry("cock", "cock", "cock"));
			try {
