...
public class AccessControlManager {
	...
	public AccessControlManager() {
		...
		userlist[3] = new User("3035566467","default", true, true);
		
		n = 4;
	}
	// Passwords of admin and kpchow are admin99 and default

	// checkUser: check if user m� already exists in the userlist
	...
	// verifyPassword: verify the password of user m� is wd�
	...
	// checkReadPerm: check if user m� has the read permission,
	...
	// checkWritePerm: check if user m� has the write permission,
